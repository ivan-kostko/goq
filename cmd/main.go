...
var (
	docRestAddr = flag.String("docRest", "0.0.0.0:", "The service address to listen for REST calls")
	docGrpcAddr = flag.String("docGrpc", "0.0.0.0:", "The service address to listen for gRPC calls")
